...
This is proposed implementation scope. Task 1 has an implementation on the
branch `standing-orders/preserve-filed-planning-contract` (schema v51),
awaiting the operator's review and integration; tasks 2 and 3 have not
started, and the milestone's completion gate has not been run.

...
describe("routines, against real git", () => {
  ...
  test("approve once; the pass fires, the instance builds, the track repeats on schedule", async () => {
    ...
    const terms: RoutineTerms = {
      ...
      touches: [],
      acceptance: [{ id: "c1", statement: "The notes file is refreshed.", how: null, evidence: ["manual-review"] }],
      requirements: [],
      schedule: "every:60",
      singleFlight: true,
      costCeilingUsd: null,
  ...
  test("a stuck instance stops the track and pages, instead of stacking twins", async () => {
    ...
    const terms: RoutineTerms = {
      ...
      outOfScope: null,
      touches: [],
      acceptance: [{ id: "c1", statement: "The flaky thing works.", how: null, evidence: ["manual-review"] }],
      requirements: [],
      schedule: "every:60",
      singleFlight: true,
      costCeilingUsd: null,

...
export function discordSettingsHtml(
  ...
  if (!credentials) {
    ...
    if (options.code) {
      ...
      content += post(
        "pair",
        "<h2>Pair your account</h2><p>Your paired Discord account can read your connected projects and confirm proposed changes. Password approvals still open in Standing Orders.</p>" +
          password +

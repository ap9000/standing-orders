...
test("v53 upgrades with unchanged account and invite authority; reopening is byte-identical", () => {
  ...
  try {
    ...
    old.exec("DROP TABLE service_cursor; DROP TABLE plan_authorization; DROP TABLE action_ledger; ALTER TABLE approver DROP COLUMN projects_json; ALTER TABLE invite DROP COLUMN projects_json; UPDATE schema_version SET version=53;");

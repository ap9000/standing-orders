...
describe("the bounded repair loop (v40, evidence-review-v1)", () => {
  ...
  test("automatic review feedback creates no follow-up without signed repair authority", () => {
    ...
    expect(maybeTriggerRepair(store, REPO, evidenceRoot, run, "short", T0)).toMatchObject({ kind: "drafted", approved: false });
  });

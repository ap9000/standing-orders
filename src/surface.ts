...
export const COMMAND_GUIDE: readonly CommandRow[] = [
  ...
  { invocation: "task add", synopsis: "queue work", audience: "agent", agentMayInvoke: true, mutation: "keyed",
    ...
    flags: [jsonFlag, dbFlag, keyFlag,
      ...
      { name: "report", takesValue: false, meaning: "a scout task: the deliverable is a report, never a branch" }],
    notableReasons: ["duplicate", "usage"] },
  { invocation: "task list", synopsis: "a page of saved task status", audience: "agent", agentMayInvoke: true, mutation: "none",
    flags: [jsonFlag, dbFlag, { name: "state", takesValue: true, meaning: "queued|running|done|failed|cancelled" },
      { name: "view", takesValue: true, meaning: "all|needs-you|running|completed" },
      { name: "limit", takesValue: true, meaning: "page size, 1–100; default 40" },
      { name: "cursor", takesValue: true, meaning: "nextCursor from the previous response" },
  ...
  { invocation: "providers", synopsis: "which agent providers this binary can drive, and their transports; --report records this machine's readiness under its runner", audience: "agent", agentMayInvoke: true, mutation: "none",
    flags: [jsonFlag,
